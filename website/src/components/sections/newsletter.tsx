              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 min-h-[48px] border border-neutral-200 rounded-md px-4 text-base text-black focus:outline-none focus:ring-2 focus:ring-[#7030A0]/20 focus:border-[#7030A0] transition-colors"
                  />
                  <button
                    type="submit"
