...
export function InfoBar() {
  return (
    <section className="bg-mathitude-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid sm:grid-cols-3 gap-8">
          {infoItems.map((item) => (
            <div key={item.title} className="flex gap-4">
              <div className="shrink-0 w-10 h-10 rounded-lg bg-mathitude-teal/10 flex items-center justify-center">
                <item.icon className="w-5 h-5 text-mathitude-teal" />
              </div>
              <div>
