    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-mathitude-light via-white to-mathitude-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-mathitude-navy leading-tight">
          ...
          <div className="mt-12 flex justify-center items-end gap-6 sm:gap-10 lg:gap-16">
            <div className="flex flex-col items-center">
              <div className="w-24 h-28 sm:w-32 sm:h-36 lg:w-40 lg:h-44 bg-gradient-to-b from-mathitude-orange/20 to-mathitude-orange/5 rounded-2xl flex items-center justify-center border-2 border-dashed border-mathitude-orange/30">
                <Calculator className="w-10 h-10 sm:w-12 sm:h-12 text-mathitude-orange" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-28 sm:w-32 sm:h-36 lg:w-40 lg:h-44 bg-gradient-to-b from-mathitude-blue/20 to-mathitude-blue/5 rounded-2xl flex items-center justify-center border-2 border-dashed border-mathitude-blue/30">
                <BookOpen className="w-10 h-10 sm:w-12 sm:h-12 text-mathitude-blue" />
              </div>
              <span className="mt-2 text-xs text-gray-400 font-medium">
                Space Chips
              </span>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-28 sm:w-32 sm:h-36 lg:w-40 lg:h-44 bg-gradient-to-b from-mathitude-purple/20 to-mathitude-purple/5 rounded-2xl flex items-center justify-center border-2 border-dashed border-mathitude-purple/30">
                <Puzzle className="w-10 h-10 sm:w-12 sm:h-12 text-mathitude-purple" />
              </div>
              <span className="mt-2 text-xs text-gray-400 font-medium">
                Rubik&apos;s Boy
              </span>
