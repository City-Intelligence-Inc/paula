      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        ...
        <div className="max-w-3xl mb-16 sm:mb-20">
          ...
          <h2
            data-reveal
            data-delay="2"
            className="text-xl sm:text-2xl font-semibold text-black tracking-tight leading-[1.3] text-balance"
          >
        ...
        <div className="grid lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-8">
            <p
              data-reveal
              data-delay="1"
              className="text-2xl sm:text-3xl text-black leading-[1.25] font-light tracking-tight"
            >
