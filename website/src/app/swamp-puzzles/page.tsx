                ...
                <article key={puzzle.level} className="flex flex-col items-center text-center">
                  ...
                  <div className="mt-5 flex flex-wrap justify-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center rounded-md bg-[#7030A0] text-white hover:bg-[#5d288a] font-medium uppercase tracking-wide text-sm px-5 py-2.5 transition-colors"
                    >
                      View PDF
                    </a>
                    <a
